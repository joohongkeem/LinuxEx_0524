...
/* sender program 은 msg1.c(receiver program) 과 매우 비슷하다.
 * delete the msg_to_receive declaration and replace it with buffer[BUFSIZ]
 * remove the message queue delete and make the following changes to the running loop.
